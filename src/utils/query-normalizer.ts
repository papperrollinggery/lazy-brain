...
const ABSTRACT_EXPANSIONS: Array<[RegExp, string[]]> = [
  ...
  [/(kotlin 开发最佳实践|kotlin最佳实践|kotlin 开发|kotlin開發)/i,
    ['kotlin', '开发', '最佳实践', 'review', 'test', 'kotlin-review', 'kotlin-test', 'android-native-dev']],
  ...
  [/(spring boot 开发|springboot 开发|spring boot)/i,
    ['spring', 'springboot', 'backend', 'java', 'development', 'backend-patterns', 'debugger', 'project-session-manager']],
  ...
  [/(写单元测试|單元測試|add unit tests?|unit tests?)/i,
    ['测试', '单元测试', 'test', 'unit-test', 'coverage', 'tdd', 'test-coverage', 'cpp-test', 'flutter-test', 'python-testing']],
  ...
  [/(重构代码让它更简洁|重構代碼讓它更簡潔|代码重构减少复杂度|代碼重構減少複雜度|refactor for readability|simplify complex code)/i,
    ['重构', '简化', '可读性', '复杂度', 'refactor', 'simplify', 'readability', 'code-simplifier', 'refactor-clean', 'minimal-change', 'ai-slop-cleaner']],
