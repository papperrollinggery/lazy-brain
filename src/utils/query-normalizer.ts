...
const ABSTRACT_EXPANSIONS: Array<[RegExp, string[]]> = [
  ...
  [/(project planning|project plan|plan project)/i,
    ['project', 'planning', 'planner', 'omc-plan', 'product-capability']],
  [/(deploy to production|production deploy|ship to production)/i,
    ['deployment', 'production', 'release', 'frontend', 'product', 'ai engineer', 'product-capability', 'frontend-design']],
  [/(重构整个后端|重構整個後端|后端重构|後端重構|refactor.*backend|backend.*refactor)/i,
    ['backend', 'refactor', 'architecture', 'backend-patterns', 'backend architect', 'refactor-clean']],
  ...
  [/(新人上手|入门|入門|看不懂|解释代码库|解釋代碼庫|介绍工程|介紹工程)/i,
    ['代码库', '导览', 'onboarding', 'code-tour', 'codebase', 'tour', 'skill-create', 'claude-code-bridge', 'code-review']],
  [/(系统架构|系統架構|架构设计|架構設計|设计系统架构|設計系統架構)/i,
    ['架构', '设计', 'architecture', 'architect', 'system-design', 'planner', 'backend-architect', 'backend architect', 'software architect']],
  ...
  [/(docker 配置|docker配置|写 docker 配置|寫 docker 配置|容器配置)/i,
    ['docker', '配置', 'container', 'configure', 'devops', 'backend-patterns', 'devops automator']],
  [/(数据库迁移|資料庫遷移|迁移数据库|遷移資料庫)/i,
    ['数据库', '迁移', 'database', 'migration', 'migrate', 'backend-patterns', 'database-optimizer']],
  [/(数据库查询优化|資料庫查詢優化|优化数据库查询|優化資料庫查詢|optimize database queries?)/i,
    ['数据库', '查询', '优化', 'database', 'query', 'optimize', 'optimizer', 'postgres', 'postgres-patterns', 'database optimizer', 'prompt-optimize']],
  [/(技术文章|技術文章|技术博客|技術博客|写技术文章|寫技術文章)/i,
    ['技术', '文章', 'technical', 'article', 'blog', 'writer', 'writing', 'article-writing', 'technical-writer']],
  [/(generate api documentation|api documentation|write api docs)/i,
    ['api', 'documentation', 'docs', 'writer', 'technical-writer', 'api-design']],
  [/(写 python 代码|寫 python 代碼|python 开发|python開發)/i,
    ['python', '代码', '开发', 'patterns', 'review', 'python-review', 'python-patterns', 'code-review']],
  [/(kotlin 开发最佳实践|kotlin最佳实践|kotlin 开发|kotlin開發)/i,
    ['kotlin', '开发', '最佳实践', 'patterns', 'review', 'test', 'kotlin-patterns', 'kotlin-review', 'kotlin-test', 'android-native-dev']],
  ...
  [/(spring boot 开发|springboot 开发|spring boot)/i,
    ['spring', 'springboot', 'backend', 'java', 'development', 'patterns', 'springboot-patterns', 'springboot-tdd', 'springboot-verification']],
  [/(performance optimization|optimize performance|性能优化)/i,
    ['performance', 'optimization', 'benchmark', 'optimizer', 'performance benchmarker', 'prompt-optimize', 'database optimizer']],
  [/(写单元测试|單元測試|add unit tests?|unit tests?)/i,
    ['测试', '单元测试', '单测', 'test', 'unit-test', 'coverage', 'tdd', 'test-coverage', 'tdd-workflow', 'test-engineer']],
  [/(提交代码|提交代碼|git commit|commit code)/i,
    ['提交', 'commit', 'git', 'code-review', 'git-commit', 'git-master', 'prp-commit']],
  [/(重构代码让它更简洁|重構代碼讓它更簡潔|代码重构减少复杂度|代碼重構減少複雜度|refactor for readability|simplify complex code)/i,
    ['重构', '简化', '可读性', '复杂度', 'refactor', 'simplify', 'readability', 'code-simplifier', 'refactor-clean', 'refactor-method-complexity-reduce', 'minimal-change', 'ai-slop-cleaner']],
  [/(修个 typo|修 typo|改个 typo|小修一下|修个错字|修个筆誤)/i,
    ['typo', 'small-fix', 'minimal-change', 'fix', 'build-fix']],
  [/(adversarial dual review|dual model review|对抗性双模型审查|對抗性雙模型審查|双模型审查|雙模型審查)/i,
